...
public class ConnectionPool {
	...
	private static int initialConnections = 3; // 连接池的初始大小
	private static int incrementalConnections = 1;// 连接池自动增加的大小
	...
	*/
	private void createConnections(int numConnections) throws SQLException {
		...
		for (int x = 0; x < numConnections; x++) {
			...
			try{
				Connection thisConn = newConnection();
				connections.addElement(new PooledConnection(thisConn));
				//System.out.println(" 数据库连接己创建 ......"+connections.size()+"......"+thisConn.toString());
